...
def insert_topic(request):
    ...
    if request.method=='POST':
        ...
        if form_data.is_valid():
            form_data.save()
            return HttpResponse('model is saves successfully')
...
def insert_webpage(request):
    ...
    if request.method=='POST':
        ...
        if form_data.is_valid():
            form_data.save()
            return HttpResponse('webpage model is saves successfully')
...
def insert_accessrecords(request):
    ...
    if request.method=='POST':
        ...
        if form_data.is_valid():
            form_data.save()
            return HttpResponse('accessrecords model is saves successfully')
